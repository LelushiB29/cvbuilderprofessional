...
<head>
    ...
    <!-- custom css -->
    <link rel = "stylesheet" href = "build-cv-bootstrap-v-5.0-website-template-master\assets\css\main.css">
        ...
        <nav class = "navbar navbar-expand-lg navbar-light bg-secondary">
            <div class="container">
                <a class = "navbar-brand fw-bold fs-2" href = "index.php">
                    ...
                    <span class = "navbar-brand-text">Build</span> CV
                </a>
                ...
                <div class = "collapse navbar-collapse" >
                    <ul class = "navbar-nav ms-auto">
                        <!-- <li class = "nav-item dropdown"> -->
                            <a href = "Free\resume-builder-using-vanilla-javascript-master\resume-builder-using-vanilla-javascript-master\resume.html" style="text-decoration:none" role = "button"><font color="black">Free Template</font></a>
                            <!-- <ul class="dropdown-menu bg-white" aria-labelledby="navbarDropdown">
                                <li>
                                    <a class = "dropdown-item" href = "Free\resume.html">Free</a>
                                </li>
                                <li>
                                    <a class = "dropdown-item" href = "Paid\Resume-Builder-master\index.html">Paid</a>
                                </li>
                            </ul> -->
                        </li>
                    </ul>
        ...
        <div class="header-banner">
            <div class="container h-100 d-flex align-items-center justify-content-center">
                <div class = "row text-center justify-content-center">
                    ...
                    <a href="login.php"><button class = "btn btn-lg text-capitalize btn-primary btn-banner fs-4">let's get started</button></a>
                </div>
            </div>
        </div>
    </header>
        ...
        <section class = "templates py-8 bg-secondary">
            <div class = "container">
                <div class = "row section-title text-center mb-5">
                    <div class = "col-12">
                        <h2 class = "display-6 text-blue fw-bold">Here we have the Best Templates for you</h2>
